 ...
 * 
 */
var obj580_onLoad_activeActionGroupIndex = -1;
var obj580_onLoad_runningActionsCount = 0;
var obj580_onLoad_loopCount = 0;
...
obj580_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj580_onLoad_activeActionGroupIndex = -1;
		$("#obj580").trigger("obj580_onLoad_ended");
		
		for (var i = 0; i < pubcoder.queuedEvents.length; i++) {
			const evt = pubcoder.queuedEvents[i];
			if (evt.senderObjectId == 580) {
				console.warn("de-queueing event obj580." + evt.eventName);
				pubcoder.queuedEvents.splice(i, 1);
				$("#obj580").trigger(evt.eventName);
				return;
			}
		}
		return;
	}
	window.obj580_onLoad_activeActionGroupIndex = 0;
...
move_839();
function move_839() {
	window.obj580_onLoad_runningActionsCount = obj580_onLoad_runningActionsCount + 1;
	...
	targetObject.animate({ left: moveX+'px', top: moveY+'px'}, 1000, easing, function() {
		setTimeout(function() {
			window.obj580_onLoad_runningActionsCount = window.obj580_onLoad_runningActionsCount - 1;
if (window.obj580_onLoad_runningActionsCount < 0) {
	window.obj580_onLoad_runningActionsCount = 0;
} else if (window.obj580_onLoad_runningActionsCount == 0) {
	obj580_onLoad_actionGroup1();
}
		}, 1);
	});
}
...
obj580_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj580_onLoad_activeActionGroupIndex = -1;
		$("#obj580").trigger("obj580_onLoad_ended");
...
obj580_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj580_onLoad_activeActionGroupIndex = -1;
		$("#obj580").trigger("obj580_onLoad_ended");
	...
	window.obj580_onLoad_activeActionGroupIndex = 2;
...
obj580_onLoad_actionGroup3 = function(){
	...
	window.obj580_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj580_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj580_onLoad is still running");
	return;
}
var obj580_onLoad_runningActionsCount = 0;
var obj580_onLoad_loopCount = 0;
obj580_onLoad_actionGroup0();
});
...
$("#obj375").trigger('SCEventShow');
$("#obj580").trigger('SCEventShow');
