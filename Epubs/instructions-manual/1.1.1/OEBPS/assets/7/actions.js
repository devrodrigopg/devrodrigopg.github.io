...
pubcoder.page.id = pubcoder.page.id || 303;
 ...
 * 
 */
var obj503_onLoad_activeActionGroupIndex = -1;
var obj503_onLoad_runningActionsCount = 0;
var obj503_onLoad_loopCount = 0;
...
obj503_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj503_onLoad_activeActionGroupIndex = -1;
		$("#obj503").trigger("obj503_onLoad_ended");
	...
	window.obj503_onLoad_activeActionGroupIndex = 0;
...
move_846();
function move_846() {
	window.obj503_onLoad_runningActionsCount = obj503_onLoad_runningActionsCount + 1;
	...
	targetObject.animate({ left: moveX+'px', top: moveY+'px'}, 700, easing, function() {
		setTimeout(function() {
			window.obj503_onLoad_runningActionsCount = window.obj503_onLoad_runningActionsCount - 1;
if (window.obj503_onLoad_runningActionsCount < 0) {
	window.obj503_onLoad_runningActionsCount = 0;
} else if (window.obj503_onLoad_runningActionsCount == 0) {
	obj503_onLoad_actionGroup1();
}
		}, 1);
	});
}
...
obj503_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj503_onLoad_activeActionGroupIndex = -1;
		$("#obj503").trigger("obj503_onLoad_ended");
...
obj503_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj503_onLoad_activeActionGroupIndex = -1;
		$("#obj503").trigger("obj503_onLoad_ended");
	...
	window.obj503_onLoad_activeActionGroupIndex = 2;
...
obj503_onLoad_actionGroup3 = function(){
	...
	window.obj503_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj503_onLoad_activeActionGroupIndex != -1) {
	console.warn("action list window.obj503_onLoad is still running");
	return;
}
var obj503_onLoad_runningActionsCount = 0;
var obj503_onLoad_loopCount = 0;
obj503_onLoad_actionGroup0();
});
