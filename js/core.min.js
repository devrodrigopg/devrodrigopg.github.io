var xreader = window.PubViewer || {
  ...
  Document: {
    Settings: {
      ...
      appIdentifier: "",
      facingPagesInLandscape: !0,
      lockOrientation: !1,
      restoreLatestPage: !0,
    },
    Renditions: { Mobile: [], Desktop: [] },
  },
  MediaOverlay: {
    IsPlaying: !1,
    IsPlayingAudio: !1,
    CurrentElement: null,
    ActiveElementClass: "-epub-media-overlay-active",
  },
  Platform: {
    Web: "Web",
    iOS: "iOS",
  ...
  Hooks: {
    _beforeNavigationHooks: [],
    _beforePageLoadHooks: [],
    _beforePagePlayHooks: [],
  ...
  ReaderSettings: {
    EnableDoublePage: !1,
    EnableRightToLeft: !1,
    EnableSwipeToNavigate: !0,
    EnablePinchToZoom: !0,
    EnableTouchToOpenAppMenu: !0,
    EnableTapToSeekReadaloud: !0,
    ViewportFitCover: !0,
  },
  NativeStorage: {
    data: {},
  ...
  onTap: function (ev, iframeEvent) {
    ...
    var eventComesFromRealClick = e.isTrusted == !0 || e.x != 0 || e.y != 0;
    ...
    if (
      ...
      xreader.wasDraggingPage = !1;
      xreader.touchActionDefaultPrevented = !0;
      return !1;
    }
  ...
  onTouchStart: function (ev, iframeEvent) {
    ...
    if (
      ...
      xreader.cancelPageSwitch(!1);
      xreader.wasDraggingPage = !1;
      xreader.draggingPage = !1;
      xreader.canDragPage = !0;
    ...
    xreader.touchActionDefaultPrevented = !1;
  },
  ...
  onTouchEnd: function (ev, iframeEvent) {
    ...
    if (xreader.draggingPage) {
      ...
      if (currentPageDx > 0 && xreader.canDragPageLeft) {
        ...
        xreader.cancelPageSwitch(!0);
        $("#overlay").hide();
      }
      e.preventDefault();
      xreader.draggingPage = !1;
      xreader.wasDraggingPage = !0;
      setTimeout(function () {
        xreader.wasDraggingPage = !1;
      }, 500);
      return;
  ...
  onWheel: function (ev, iframeEvent) {
    ...
    if (
      ...
      xreader.accWheelX = 0;
      xreader.accWheelY = 0;
      xreader.wheelTime = Date.now() + 800;
      if (x > 0) {
        xreader.callAppMethod("GoToPageAtRight", []);
      } else {
        xreader.callAppMethod("GoToPageAtLeft", []);
  ...
  initReaderPage: function (iframeElement, src, pagePageInstanceId) {
    ...
    event.initEvent("SCEventPageLoad", !1, !0);
...
XPUB.prototype.ready = function () {
  ...
  setTimeout(function () {
    ...
    event.initEvent("SCEventPagePlay", !1, !0);
...
XPUB.prototype.isReadAloudActive = !1;
XPUB.prototype.isReadAloudPlayingAudio = !1;
